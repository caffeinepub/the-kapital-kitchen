...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 sm:py-28 bg-kapital-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1200px] mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal relative rounded-2xl overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-2xl border border-kapital-amber/20" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-4 bg-kapital-bg/90 backdrop-blur-sm border border-kapital-amber/40 rounded-xl px-4 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber font-cinzel font-bold text-lg", children: "Since Day One" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-xs", children: "Serving Vasai with love 🍜" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal reveal-delay-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "Our Story" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-2xl sm:text-3xl font-bold text-white tracking-wide mb-6 leading-tight", children: "Bringing the Best Chinese Flavors to Vasai" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted leading-relaxed mb-8 text-sm sm:text-base", children: "The Kapital Kitchen was born from a simple belief — great food should be affordable, fast, and available when you need it most. Located in the heart of Vasai West, we've been serving bold Chinese flavors to students, families, and late-night cravings since day one." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted leading-relaxed mb-8 text-sm sm:text-base", children: "Every dish is crafted with fresh ingredients, wok-tossed to perfection with the same love and dedication we had on our very first day. From crispy spring rolls to fiery chili chicken — every bite tells our story." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pill.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: pill.label })
          ]
        },
        pill.label
      )) })
...
const WA_LINK$5 = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
function ContactSection() {
  const [form, setForm] = reactExports.useState({ name: "", phone: "", message: "" });
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      ue.success("Message sent! We'll call you back soon 😊");
    }, 800);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 sm:py-28 bg-kapital-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-3xl sm:text-4xl font-bold text-white tracking-wide uppercase", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-kapital-amber mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-kapital-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
...
const WA_LINK$4 = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
const dishes = [
  {
...
function FeaturedDishes() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "featured", className: "py-20 sm:py-28 bg-kapital-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "Our Specialties" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-3xl sm:text-4xl font-bold text-white tracking-wide uppercase", children: "Our Signature Dishes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-kapital-amber mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6", children: dishes.map((dish, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden h-40 sm:h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: dish.image,
              alt: dish.name,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-kapital-text text-sm sm:text-base mb-1 leading-tight", children: dish.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-xs mb-3 leading-relaxed", children: dish.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-kapital-amber text-base font-cinzel", children: dish.price }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: WA_LINK$4,
...
const WA_LINK$3 = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
function FloatingWhatsApp() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-6 right-6 z-50 group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-full right-0 mb-2 whitespace-nowrap bg-kapital-card border border-kapital-border text-kapital-text text-xs font-semibold px-3 py-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-lg", children: "Order on WhatsApp" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: WA_LINK$3,
        target: "_blank",
        rel: "noopener noreferrer",
        className: "wa-pulse w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center shadow-xl transition-colors",
...
const WA_LINK$2 = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
const quickLinks = [
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-kapital-bg border-t border-kapital-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6 py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🍜" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-cinzel text-base font-bold tracking-widest text-kapital-amber uppercase", children: "The Kapital Kitchen" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-sm mb-4 italic", children: "Fast. Fresh. Affordable." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-xs leading-relaxed", children: "Vasai West, Maharashtra — serving bold Chinese flavors since day one." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-cinzel text-xs font-bold tracking-widest text-kapital-amber uppercase mb-4", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-cinzel text-xs font-bold tracking-widest text-kapital-amber uppercase mb-4", children: "Follow Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "w-9 h-9 rounded-full border border-kapital-border flex items-center justify-center text-kapital-muted hover:text-kapital-amber hover:border-kapital-amber transition-colors",
              "aria-label": "Facebook",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { size: 16 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "w-9 h-9 rounded-full border border-kapital-border flex items-center justify-center text-kapital-muted hover:text-kapital-amber hover:border-kapital-amber transition-colors",
              "aria-label": "Twitter",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Twitter, { size: 16 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-kapital-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-kapital-muted", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        year,
        " The Kapital Kitchen. All rights reserved. | Vasai West, Maharashtra"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
const WA_LINK$1 = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
function HeroSection() {
  const scrollToMenu = () => {
    var _a2;
    (_a2 = document.querySelector("#menu")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-noodles.dim_1200x600.jpg')"
            }
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-[1200px] mx-auto px-6 py-24 pt-36", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full border border-kapital-amber/50 bg-kapital-amber/10 text-kapital-amber text-sm font-medium mb-6 backdrop-blur-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌙" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase tracking-widest text-xs font-semibold", children: "Open Till Late Night" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs sm:text-sm uppercase tracking-[0.3em] font-semibold mb-4", children: "Vasai West, Maharashtra" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-cinzel text-3xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-wide max-w-3xl mb-6", children: [
            "Best Chinese Food",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-kapital-amber", children: "in Vasai" }),
            " –",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Fast, Fresh & Affordable"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-base sm:text-lg max-w-xl mb-10 leading-relaxed", children: "Late-night delivery & takeaway — because hunger doesn’t wait" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-8 mt-14 pt-8 border-t border-white/10", children: [
            { value: "500+", label: "Happy Customers" },
            { value: "4.8★", label: "Average Rating" },
            { value: "2 AM", label: "We Stay Open" }
          ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-cinzel text-2xl font-bold text-kapital-amber", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-kapital-muted text-sm mt-0.5", children: stat.label })
          ] }, stat.label)) })
        ] })
      ]
    }
...
function MenuSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "menu", className: "py-20 sm:py-28 bg-kapital-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "What We Serve" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-3xl sm:text-4xl font-bold text-white tracking-wide uppercase", children: "Explore Our Menu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-kapital-amber mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-2 mb-10 reveal", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setActive(cat),
        className: `px-5 py-2 rounded-full text-sm font-semibold transition-all uppercase tracking-wider border ${active === cat ? "bg-kapital-amber text-kapital-bg border-kapital-amber" : "bg-kapital-card text-kapital-muted border-kapital-border hover:border-kapital-amber hover:text-kapital-amber"}`,
        "data-ocid": "menu.tab",
        children: cat
      },
      cat
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filtered.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `w-3 h-3 rounded-sm border-2 ${item.veg ? "border-green-500" : "border-red-500"} flex items-center justify-center`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-kapital-text text-sm leading-tight mb-0.5", children: item.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-xs leading-relaxed", children: item.desc })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-kapital-amber text-sm font-cinzel", children: item.price }) })
        ]
      },
      item.name
    )) })
...
const WA_LINK = "https://wa.me/919999999999?text=Hi%2C%20I%20want%20to%20order%20from%20The%20Kapital%20Kitchen";
const navLinks = [
  { label: "Home", href: "#home" },
  { label: "Menu", href: "#menu" },
  { label: "About", href: "#about" },
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-kapital-bg/95 backdrop-blur-md shadow-lg border-b border-kapital-border" : "bg-transparent backdrop-blur-sm"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-[1200px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🍜" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-cinzel text-sm sm:text-base font-bold tracking-widest text-kapital-amber uppercase leading-tight", children: "The Kapital Kitchen" })
              ]
            }
          ),
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-kapital-card border-b border-kapital-border px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-col gap-4", children: [
...
function StarRating({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0.5", children: [
    starKeys.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-kapital-amber text-lg", children: "★" }, key)),
    half && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-kapital-amber text-lg", children: "⯨" })
  ] });
}
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 sm:py-28 bg-kapital-bg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "Reviews" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-3xl sm:text-4xl font-bold text-white tracking-wide uppercase", children: "What Our Customers Say" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-kapital-amber mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: reviews.map((review, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { stars: review.stars, reviewName: review.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-kapital-text text-sm leading-relaxed my-4", children: [
            '"',
            review.text,
            '"'
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-kapital-amber/20 border border-kapital-amber/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-kapital-amber font-bold text-sm", children: review.name[0] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-kapital-amber text-sm", children: review.name })
          ] })
        ]
      },
      review.name
...
function WhyChooseUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 sm:py-28", style: { background: "#1A1D1F" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-amber text-xs uppercase tracking-[0.3em] font-semibold mb-3", children: "Our Promise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-cinzel text-3xl sm:text-4xl font-bold text-white tracking-wide uppercase", children: "Why Choose The Kapital Kitchen?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-kapital-amber mx-auto mt-4" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-5", children: features.map((feat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-4", children: feat.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-cinzel font-bold text-white text-sm sm:text-base mb-2 tracking-wide", children: feat.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-kapital-muted text-xs sm:text-sm leading-relaxed", children: feat.desc })
        ]
      },
      feat.title
    )) })
...
function App() {
  useScrollReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-kapital-bg text-kapital-text", children: [
